...
import { b as Component, C as CollaborationSection, d as Button } from './Panel_CAMdPLdB.mjs';
...
const getIcon = (props) => {
  ...
  switch (iconType) {
    ...
    case "info":
      return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 20 20", fill, xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", clipRule: "evenodd", fill: "#6B7280" }) });
    case "new-file":
    ...
    case "heart":
      return /* @__PURE__ */ jsx("svg", { className: `${className} text-red-700`, fill, stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", d: "M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z", clipRule: "evenodd" }) });
    case "vote-priority":
    ...
    default:
      if (iconType.includes("Communication")) {
        return /* @__PURE__ */ jsx("svg", { className: `${className} text-purple-600`, fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", d: "M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z", clipRule: "evenodd" }) });
      } else {
...
const C = (props) => {
  const pageLike = /* @__PURE__ */ jsxs(Component, { bg: props.bg, className: props.className || "", children: [
    props.titleCenter ? /* @__PURE__ */ jsxs("h2", { className: "mb-2 text-xl flex items-center justify-center", children: [
      props.icon && getIcon(props.icon),
      props.title
    ] }) : /* @__PURE__ */ jsxs("h2", { className: `mb-2 font-medium flex justify-between h-8`, children: [
      /* @__PURE__ */ jsxs("div", { className: `flex items-center`, children: [
        props.icon && getIcon(props.icon),
        /* @__PURE__ */ jsx("div", { className: "ml-1", children: props.title })
      ] }),
      props.rightHeader
    ] }),
    props.subtitle && /* @__PURE__ */ jsx("p", { className: "text-xs mb-2 -mt-2.5", children: props.subtitle }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3 text-gray-500 text-sm", children: props.children }),
    /* @__PURE__ */ jsx("div", { className: "flex justify-center mt-4", children: props.actions && props.actions.map((action) => action.href ? /* @__PURE__ */ jsx(CollaborationSection, { variant: action.variant, href: action.href, className: "w-full mt-4" + action.className || "", children: action.children }) : /* @__PURE__ */ jsx(Button, { variant: action.variant, onClick: action.onClick, className: "w-full mt-4" + action.className || "", children: action.children })) })
  ] }, props.key);
  const dropDownedPagelike = /* @__PURE__ */ jsx(Component, { bg: props.bg, className: props.className || "", children: /* @__PURE__ */ jsxs("div", { className: "collapse collapse-arrow rounded-none", children: [
    /* @__PURE__ */ jsx("input", { type: "checkbox", className: "peer" }),
    /* @__PURE__ */ jsx("div", { className: `collapse-title flex`, children: /* @__PURE__ */ jsxs("h3", { className: "font-medium text-gray-700 flex items-center justify-between", children: [
      props.title,
      props.rightHeader
    ] }) }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "space-y-3 text-sm", children: props.children }),
          /* @__PURE__ */ jsx("div", { className: "flex justify-center mt-4", children: props.actions && props.actions.map((action) => action.href ? /* @__PURE__ */ jsx(CollaborationSection, { variant: action.variant, href: action.href, className: "w-full mt-4" + action.className || "", children: action.children }) : /* @__PURE__ */ jsx(Button, { variant: action.variant, onClick: action.onClick, className: "w-full mt-4" + action.className || "", children: action.children })) })
        ]
      }
    )
