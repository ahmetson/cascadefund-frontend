...
const Component = ({ children, content }) => {
  return /* @__PURE__ */ jsx(TooltipProvider, { openDelay: 50, children: /* @__PURE__ */ jsxs(Tooltip, { children: [
    /* @__PURE__ */ jsx(TooltipTrigger, { className: ``, children }),
    /* @__PURE__ */ jsx(TooltipContent, { className: "bg-teal-900 text-blue-100 border-color-teal-900", children: content })
  ] }) });
};
