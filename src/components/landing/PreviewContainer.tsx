  ...
  return (
    <div className={`terminal-window ${className}`}>
      <div className="terminal-header">
        ...
        {previewUrl.length > 0 && <>
          {staticUrl ? <span className="font-mono text-xs text-gray-400 ml-1">{previewUrl}</span> : <Link asNewTab={true} className="font-mono text-xs text-gray-400 ml-1 " uri={previewUrl}>
