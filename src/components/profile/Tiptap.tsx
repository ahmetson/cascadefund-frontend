...
import { Popover, PopoverClose, PopoverContent, PopoverTrigger } from '../animate-ui/components/radix/popover'
...
function MenuBar({ editor }: { editor: Editor }) {
    ...
    return (
        <div className="flex flex-wrap flex-row justify-start items-center gap-2 w-full">
            <Button
                variant='secondary'
...
export default () => {
    ...
    return (
        <Popover open={isFocused} onOpenChange={setIsFocused}>
            <PopoverTrigger onClick={() => console.log('clicked')} asChild>
