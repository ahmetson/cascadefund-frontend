...
const CollaborationSection: React.FC = () => {
  ...
  return (
    <Card
      ...
      actions={[{
        variant: "transparent", children: <div className='relative inline-flex items-center bg-blue-400 hover:bg-blue-600 text-white font-bold py-2 px-4  rounded transition-colors'>Influencer Work {buttonWithIcon}</div>,
