        ...
        <div className="lg:pl-8">
          <Card className="bg-white text-gray-900 p-6">
            <h3 className="text-lg font-semibold mb-4">
              Obtain voting power for "NodeDB Toolkit"
            </h3>
            ...
            <div className="space-y-4">
              ...
              <a href="/v2/influencer/welcome" className="bg-stone-700 hover:bg-stone-900 text-white font-bold py-2 px-4 border border-slate-700 rounded transition-colors">
                Become an Influencer
              </a>
              </p>
