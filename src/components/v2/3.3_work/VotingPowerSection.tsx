...
const VotingPowerSection: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <div className="p-4">
          <h3 className="font-medium text-gray-900 mb-4">How to work with tasks?</h3>
      ...
      <Card>
        <div className="p-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Your Voting Power</h3>
