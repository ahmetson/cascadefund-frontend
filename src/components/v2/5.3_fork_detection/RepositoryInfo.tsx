...
const RepositoryInfo: React.FC = () => {
  return (
    <div className="mb-6">
      <h2 className="text-lg font-medium text-gray-800 mb-4">Original Repository Information</h2>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-medium text-gray-900">blockchain-verification-tool</h3>
