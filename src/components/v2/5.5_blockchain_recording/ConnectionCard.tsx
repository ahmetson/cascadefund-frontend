  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">Registering Blockchain Record</h2>
      ...
      <div className="flex justify-center">
        <LinkBtn variant="purple" label="Finish" href='/v2/maintainer/project/completed' />
      </div>
    </div>
  )
}
