      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <a href="/v2/issue/post">
            <div className="mt-4 p-3 border-2 border-dashed border-gray-300 bg-gray-300 hover:bg-blue-500 hover:border-blue-900 rounded-lg text-center">
              <span className="text-sm text-gray-500">Add an issue</span>
            </div>
            </a>
          </div>
