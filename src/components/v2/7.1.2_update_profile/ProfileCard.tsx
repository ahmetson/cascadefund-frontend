    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex items-start space-x-4">
        ...
        <div className="text-right">
          ...
          <LinkBtn variant="blue" label='Save Changes' href='/v2/data/profile' />
        </div>
      </div>
      
      <div className="mt-4 pt-4 border-t">
        <LinkBtn variant="orange" label="Log out" href="/v2" />
        <Link className="ml-4 text-sm text-blue-600 cursor-pointer" label="View All Projects" href='/v2/data/projects' />
