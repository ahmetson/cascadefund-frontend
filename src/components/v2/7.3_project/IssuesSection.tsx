      ...
      <div className="p-6 border-b border-gray-200">
        ...
        <div className="flex items-center space-x-4 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <a href="/v2/maintainer/work" className="text-blue-600 hover:underline">Issues and roadmap</a>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <a href="/v2/influencer/project" className="text-blue-600 hover:underline">Become an Influencer</a>
          </div>
        </div>
      </div>
