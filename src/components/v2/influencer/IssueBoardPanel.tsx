...
import IssueCard from '@/components/v2/issue/IssueLinkPanel2'
...
const IssuesSection: React.FC = () => {
  ...
  return (
    <Card title={<>Issues <Badge variant="gray">4</Badge></>} rightHeader={<LinkBtn variant="blue" href="/v2/issue/post" >Add Issue</LinkBtn>}>
      <div className="p-6">
        <div className="mb-6">
