...
const ProjectHeader: React.FC = () => {
  return (
    <Card className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
      <Horizontally>
      ...
      <NotificationBanner type="warning" title={'Not registered on CascadeFund'} 
        icon={<svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
