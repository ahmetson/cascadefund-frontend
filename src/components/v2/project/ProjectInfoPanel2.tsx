...
import StatCard from '@/components/v2/StatInfoPanel2'
import CollaborationChart from '@/components/v2/CollaborationChart'
...
const ProjectCard: React.FC<ProjectInfoProps> = ({
  ...
  return (
    <a href="/v2/data/project" className="px-6 bg-white rounded-lg shadow-sm border-2 block border-blue-300 hover:bg-gray-200 hover:border-blue-400 p-6">
