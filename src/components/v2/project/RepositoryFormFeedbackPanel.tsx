...
const InfoPanel: React.FC = () => {
  return (
    <Card className="bg-gray-50" title={
      <div className="flex items-start space-x-3 mb-4">
        <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <h3 className="font-medium text-gray-800 mb-1">What if I don't use GitHub, but other hosting server?</h3>
      </div>}

      actions={[{
        href: '#',
        children: <><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
